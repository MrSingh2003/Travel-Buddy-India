...
export const translations: Translations = {
  ...
  bn: {
    ...
    features: {
        ...
        localTransport: { title: 'নির্বিঘ্ন যাত্রা', description: 'স্বচ্ছ মূল্য সহ যাচাইকৃত স্থানীয় ক্যাব, বাস এবং ট্রেন খুঁজুন এবং তুলনা করুন।' },
  ...
  gu: {
    ...
    features: {
        ...
        localTransport: { title: 'સરળ મુસાફરી', description: 'સ્પષ્ટ ભાવો સાથે ચકાસાયેલ સ્થાનિક કેબ, બસો અને ટ્રેનો શોધો અને સરખામણી કરો.' },
  ...
  kn: {
    ...
    features: {
        ...
        localTransport: { title: 'ಸುಗಮ ಪ್ರಯಾಣಗಳು', description: 'ಸ್ಪಷ್ಟ ಬೆಲೆಗಳೊಂದಿಗೆ ಪರಿಶೀಲಿಸಿದ ಸ್ಥಳೀಯ ಕ್ಯಾಬ್‌ಗಳು, ಬಸ್‌ಗಳು ಮತ್ತು ರೈಲುಗಳನ್ನು ಹುಡುಕಿ ಮತ್ತು ಹೋಲಿಕೆ ಮಾಡಿ.' },
  ...
  ml: {
    ...
    features: {
        ...
        localTransport: { title: 'തടസ്സമില്ലാത്ത യാത്രകൾ', description: 'വ്യക്തമായ വിലനിർണ്ണയത്തോടെ പരിശോധിച്ചുറപ്പിച്ച പ്രാദേശിക ക്യാബുകൾ, ബസുകൾ, ട്രെയിനുകൾ എന്നിവ കണ്ടെത്തുകയും താരതമ്യം ചെയ്യുകയും ചെയ്യുക.' },
  ...
  mr: {
    ...
    features: {
        ...
        localTransport: { title: 'अखंड प्रवास', description: 'स्पष्ट किंमतींसह सत्यापित स्थानिक कॅब, बस आणि ट्रेन शोधा आणि त्यांची तुलना करा.' },
  ...
  pa: {
    ...
    features: {
        ...
        localTransport: { title: 'ਸਹਿਜ ਯਾਤਰਾਵਾਂ', description: 'ਸਪਸ਼ਟ ਕੀਮਤਾਂ ਨਾਲ ਪ੍ਰਮਾਣਿਤ ਸਥਾਨਕ ਕੈਬ, ਬੱਸਾਂ ਅਤੇ ਰੇਲ ਗੱਡੀਆਂ ਲੱਭੋ ਅਤੇ ਤੁਲਨਾ ਕਰੋ।' },
  ...
  ta: {
    ...
    features: {
        ...
        localTransport: { title: 'தடையற்ற பயணங்கள்', description: 'தெளிவான விலைகளுடன் சரிபார்க்கப்பட்ட உள்ளூர் வண்டிகள், பேருந்துகள் மற்றும் ரயில்களைக் கண்டுபிடித்து ஒப்பிடவும்.' },
  ...
  te: {
    ...
    features: {
        ...
        localTransport: { title: 'అతుకులు లేని ప్రయాణాలు', description: 'స్పష్టమైన ధరలతో ధృవీకరించబడిన స్థానిక క్యాబ్‌లు, బస్సులు మరియు రైళ్లను కనుగొని పోల్చండి.' },
