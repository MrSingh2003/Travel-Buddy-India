...
export const translations: Translations = {
  ...
  bn: {
    ...
    features: {
        ...
        navigation: { title: 'নেভিগেশন এবং অন্বেষণ', description: 'আমাদের মানচিত্র বৈশিষ্ট্য সহ রিয়েল-টাইম দিকনির্দেশ পান এবং রুটগুলি অন্বেষণ করুন।' },
  ...
  gu: {
    ...
    features: {
        ...
        navigation: { title: 'નેવિગેશન અને અન્વેષણ', description: 'અમારી નકશા સુવિધા સાથે રીઅલ-ટાઇમ દિશાઓ મેળવો અને માર્ગોનું અન્વેષણ કરો.' },
  ...
  kn: {
    ...
    features: {
        ...
        navigation: { title: 'ನ್ಯಾವಿಗೇಷನ್ ಮತ್ತು ಅನ್ವೇಷಿಸಿ', description: 'ನಮ್ಮ ನಕ್ಷೆ ವೈಶಿಷ್ಟ್ಯದೊಂದಿಗೆ ನೈಜ-ಸಮಯದ ನಿರ್ದೇಶನಗಳನ್ನು ಪಡೆಯಿರಿ ಮತ್ತು ಮಾರ್ಗಗಳನ್ನು ಅನ್ವೇಷಿಸಿ.' },
  ...
  ml: {
    ...
    features: {
        ...
        navigation: { title: 'നാവിഗേഷനും പര്യവേക്ഷണവും', description: 'ഞങ്ങളുടെ മാപ്പ് ഫീച്ചർ ഉപയോഗിച്ച് തത്സമയ ദിശകൾ നേടുകയും റൂട്ടുകൾ കണ്ടെത്തുകയും ചെയ്യുക.' },
  ...
  mr: {
    ...
    features: {
        ...
        navigation: { title: 'नेव्हिगेशन आणि अन्वेषण', description: 'आमच्या नकाशा वैशिष्ट्यासह रिअल-टाइम दिशानिर्देश मिळवा आणि मार्ग एक्सप्लोर करा.' },
  ...
  pa: {
    ...
    features: {
        ...
        navigation: { title: 'ਨੇਵੀਗੇਸ਼ਨ ਅਤੇ ਪੜਚੋਲ', description: 'ਸਾਡੀ ਨਕਸ਼ੇ ਦੀ ਵਿਸ਼ੇਸ਼ਤਾ ਨਾਲ ਰੀਅਲ-ਟਾਈਮ ਦਿਸ਼ਾ-ਨਿਰਦੇਸ਼ ਪ੍ਰਾਪਤ ਕਰੋ ਅਤੇ ਰੂਟਾਂ ਦੀ ਪੜਚੋਲ ਕਰੋ।' },
  ...
  ta: {
    ...
    features: {
        ...
        navigation: { title: 'வழிசெலுத்தல் மற்றும் ஆராயுங்கள்', description: 'எங்கள் வரைபட அம்சத்துடன் நிகழ்நேர திசைகளைப் பெறுங்கள் மற்றும் வழிகளை ஆராயுங்கள்.' },
  ...
  te: {
    ...
    features: {
        ...
        navigation: { title: 'నావిగేషన్ మరియు అన్వేషించండి', description: 'మా మ్యాప్ ఫీచర్‌తో నిజ-సమయ దిశలను పొందండి మరియు మార్గాలను అన్వేషించండి.' },
