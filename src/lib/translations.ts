...
export const translations: Translations = {
  ...
  kn: {
    ...
    features: {
        ...
        routePlanner: { title: 'ಸಂವಾದಾತ್ಮಕ ಮಾರ್ಗ ಯೋಜಕ', description: 'ನಮ್ಮ ಸಂವಾದಾತ್ಮಕ ನಕ್ಷೆಯೊಂದಿಗೆ ನಿಮ್ಮ ಪ್ರಯಾಣದ ಮಾರ್గವನ್ನು ದೃಶ್ಯೀಕರಿಸಿ, ಚಾಲನಾ ನಿರ್ದೇಶನಗಳನ್ನು ಪಡೆಯಿರಿ ಮತ್ತು ಪ್ರಯಾಣದ ಸಮಯವನ್ನು ಅಂದಾಜು ಮಾಡಿ.' },
    },
    tripPlanner: {
