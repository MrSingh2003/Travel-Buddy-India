...
export const translations: Translations = {
  en: {
    ...
    features: {
      ...
      navigation: {
        title: 'Navigation',
        description: 'Get real-time directions and explore routes with our map feature.',
      },
      offlineMaps: {
        title: 'Offline Maps',
  ...
  hi: {
    ...
    features: {
      ...
      navigation: {
        title: 'नेविगेशन',
        description: 'हमारी मानचित्र सुविधा के साथ वास्तविक समय के दिशा-निर्देश प्राप्त करें और मार्गों का पता लगाएं।',
      },
      offlineMaps: {
  ...
  bn: {
    nav: { dashboard: 'ড্যাশবোর্ড', explore: 'অন্বেষণ', support: 'সমর্থন' },
    ...
    features: {
        ...
        navigation: { title: 'নেভিগেশন', description: 'আমাদের মানচিত্র বৈশিষ্ট্য সহ রিয়েল-টাইম দিকনির্দেশ পান এবং রুটগুলি অন্বেষণ করুন।' },
  ...
  gu: {
    nav: { dashboard: 'ડેશબોર્ડ', explore: 'અન્વેષણ', support: 'આધાર' },
    ...
    features: {
        ...
        navigation: { title: 'નેવિગેશન', description: 'અમારી નકશા સુવિધા સાથે રીઅલ-ટાઇમ દિશાઓ મેળવો અને માર્ગોનું અન્વેષણ કરો.' },
        offlineMaps: { title: 'ઑફલાઇન નકશા', description: 'ઇન્ટરનેટ વિના પણ આત્મવિશ્વાસ સાથે નેવિગેટ કરવા માટે નકશા અને માર્ગો સાચવો.' }
    }
  },
  kn: {
    nav: { dashboard: 'ಡ್ಯಾಶ್‌ಬೋರ್ಡ್', explore: 'ಅನ್ವೇಷಿಸಿ', support: 'ಬೆಂಬಲ' },
    ...
    features: {
        ...
        navigation: { title: 'ನ್ಯಾವಿಗೇಷನ್', description: 'ನಮ್ಮ ನಕ್ಷೆ ವೈಶಿಷ್ಟ್ಯದೊಂದಿಗೆ ನೈಜ-ಸಮಯದ ನಿರ್ದೇಶನಗಳನ್ನು ಪಡೆಯಿರಿ ಮತ್ತು ಮಾರ್ಗಗಳನ್ನು ಅನ್ವೇಷಿಸಿ.' },
  ...
  ml: {
    nav: { dashboard: 'ഡാഷ്ബോർഡ്', explore: 'പര്യവേക്ഷണം ചെയ്യുക', support: 'പിന്തുണ' },
    ...
    features: {
        ...
        navigation: { title: 'നാവിഗേഷൻ', description: 'ഞങ്ങളുടെ മാപ്പ് ഫീച്ചർ ഉപയോഗിച്ച് തത്സമയ ദിശകൾ നേടുകയും റൂട്ടുകൾ കണ്ടെത്തുകയും ചെയ്യുക.' },
  ...
  mr: {
    nav: { dashboard: 'डॅशबोर्ड', explore: 'अन्वेषण', support: 'समर्थन' },
    ...
    features: {
        ...
        navigation: { title: 'नेव्हिगेशन', description: 'आमच्या नकाशा वैशिष्ट्यासह रिअल-टाइम दिशानिर्देश मिळवा आणि मार्ग एक्सप्लोर करा.' },
        offlineMaps: { title: 'ऑफलाइन नकाशे', description: 'इंटरनेटशिवायही आत्मविश्वासाने नेव्हिगेट करण्यासाठी नकाशे आणि मार्ग जतन करा.' }
    }
  },
  pa: {
    nav: { dashboard: 'ਡੈਸ਼ਬੋਰਡ', explore: 'ਪੜਚੋਲ ਕਰੋ', support: 'ਸਹਾਇਤਾ' },
    ...
    features: {
        ...
        navigation: { title: 'ਨੇਵੀਗੇਸ਼ਨ', description: 'ਸਾਡੀ ਨਕਸ਼ੇ ਦੀ ਵਿਸ਼ੇਸ਼ਤਾ ਨਾਲ ਰੀਅਲ-ਟਾਈਮ ਦਿਸ਼ਾ-ਨਿਰਦੇਸ਼ ਪ੍ਰਾਪਤ ਕਰੋ ਅਤੇ ਰੂਟਾਂ ਦੀ ਪੜਚੋਲ ਕਰੋ।' },
        offlineMaps: { title: 'ਔਫਲਾਈਨ ਨਕਸ਼ੇ', description: 'ਬਿਨਾਂ ਇੰтерਨੈਟ ਦੇ ਵੀ ਭਰੋਸੇ ਨਾਲ ਨੈਵੀਗੇਟ ਕਰਨ ਲਈ ਨਕਸ਼ੇ ਅਤੇ ਰੂਟ ਸੁਰੱਖਿਅਤ ਕਰੋ।' }
    }
  },
  ta: {
    nav: { dashboard: 'แดชบอร์ด', explore: 'ஆராயுங்கள்', support: 'ஆதரவு' },
    ...
    features: {
        ...
        navigation: { title: 'வழிசெலுத்தல்', description: 'எங்கள் வரைபட அம்சத்துடன் நிகழ்நேர திசைகளைப் பெறுங்கள் மற்றும் வழிகளை ஆராயுங்கள்.' },
  ...
  te: {
    nav: { dashboard: 'డాష్‌బోర్డ్', explore: 'అన్వేషించండి', support: 'మద్దతు' },
    ...
    features: {
        ...
        navigation: { title: 'నావిగేషన్', description: 'మా మ్యాప్ ఫీచర్‌తో నిజ-సమయ దిశలను పొందండి మరియు మార్గాలను అన్వేషించండి.' },
